...
Poll `task_get` or `task_events` using the last event ID as a cursor. Report meaningful phase changes, blockers, approval requests, and completed verification; do not relay every low-level event.
