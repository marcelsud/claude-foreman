...
from claude_foreman import __version__
...
class DualPluginMetadataTests(unittest.TestCase):
    def test_manifests_share_identity_version_and_repository(self) -> None:
        ...
        self.assertEqual("claude-foreman", codex["name"])
    ...
    def test_each_host_uses_its_supported_plugin_root_convention(self) -> None:
        ...
        codex_server = codex_mcp["mcpServers"]["claude-foreman"]
        claude_server = claude["mcpServers"]["claude-foreman"]
    ...
    def test_claude_marketplace_points_to_the_shared_plugin(self) -> None:
        ...
        self.assertEqual("claude-foreman", entry["name"])
        self.assertEqual("./plugins/claude-foreman", entry["source"])
